...
router.post("/administrar/create", upload.single('imagen'), productValidations, controllersAdmin.save);
...
router.put('/administrar/edit/:id', upload.single('imagen'), productValidations, controllersAdmin.update);
